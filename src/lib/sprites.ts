...
export const ANIMATED_UNITS = [
    ...
    // R ユニット batch 5
    'r_sailor_rose', 'r_solar_spike', 'r_space_botanist', 'r_sprinkler_cat', 'r_sprout_knight',
...
export const RANGED_SPRITE_UNITS = [
    ...
    // New UR遠距離ユニット (2026-02)
    'ur_alien_mothership',   // エイリアン母艦 ビーム (350, area 120)
    'ur_lightning_emperor',  // 雷帝 サンダー (320, piercing)
    'ur_cosmic_eye',         // コズミックアイ ビーム (320, piercing)
    'ur_eldritch_horror',    // エルドリッチホラー ビーム (300, area 130)
    'ur_void_eye',           // ヴォイドアイ ビーム (300, area 120)
    'ur_celestial_destroyer', // セレスティアルデストロイヤー 斬撃波 (280, area 100)
    'ur_hellfire_lord',      // ヘルファイアロード 炎ブラスト (260, area 95)
    // SSR遠距離/範囲攻撃ユニット
