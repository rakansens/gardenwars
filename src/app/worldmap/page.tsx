...
const AREA_TABS: {
    ...
    {
        key: "frozen",
        labelKey: "difficulty_frozen",
        subKey: "difficulty_frozen_sub",
        icon: "❄️",
        gradient: "from-cyan-400 to-blue-600",
        banner: "/assets/stages/frozen_banner.webp",
    },
    {
        key: "hard",
    ...
    {
        key: "nightmare",
        labelKey: "difficulty_nightmare",
        subKey: "difficulty_nightmare_sub",
        icon: "💀",
        gradient: "from-purple-900 to-black",
        banner: "/assets/stages/nightmare_banner.webp",
    },
    {
        key: "boss",
