...
-- Rankings table: for future leaderboard feature
...
-- For now, allow all operations (we handle auth in the app with PIN)
ALTER TABLE players ENABLE ROW LEVEL SECURITY;
ALTER TABLE player_data ENABLE ROW LEVEL SECURITY;
ALTER TABLE rankings ENABLE ROW LEVEL SECURITY;

-- Allow anonymous access for all operations (PIN-based auth handled in app)
